...
//                    Toast.makeText(context, "Document Downloaded Successfully", Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(Void... arg0) {
             File RootDirectoryFacebookShow = new File(Environment.getExternalStorageDirectory() + "/Download/StatusSaver/Facebook");
            try {
                ...
                c.connect();
                FileOutputStream fos = new FileOutputStream(new File(RootDirectoryFacebookShow,"Roboto-Regular.ttf")); // File you want to save to, It creates Roboto-Regular.ttf in your Internal Storage you got from "getFilesDir() method
...
//
//                    apkStorage = new File(Environment.getStorageDirectory() + "/" + "CodePlayon");
//                } else
